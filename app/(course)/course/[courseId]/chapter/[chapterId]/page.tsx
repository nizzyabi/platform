...
const ChapterIdPage = async ({
  ...
  return (
    <div className="w-full mx-3.5 overflow-hidden mb-5 ">
        {isLocked ? (
        ...
        {chapter.code && chapter.code.trim().length > 0 && (
            <div> 
                ...
                <div className="bg-[#18181B] border border-white/30 rounded-[4px] rounded-t-[8px] mt-5">
                    <div className="border-b rounded-t-[5px] border-white/10 px-2.5 py-2">
