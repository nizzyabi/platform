...
interface LanguageImage3Props {
  initialData: Course
  courseId: string;
};

const formSchema = z.object({
  language3: z.string().min(1, {
    message: "Image is required",
  }),
});

export const Language3ImageForm = ({
  initialData,
  courseId
}: LanguageImage3Props) => {
