    ...
    <>
      <div className="lg:px-[250px] md:px-[50px] sm:px-6 pt-40">
          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-center w-full">
              <div className="flex flex-col gap-y-2">
                <h1 className="text-5xl font-bold">Chapter Creation</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div className="space-y-4">
            <div>
              <div className="flex items-center gap-x-2">
                <h2 className="text-3xl font-bold">Customize chapter</h2>
              </div>
              <ChapterTitleForm
                initialData={chapter}
                courseId={params.courseId}
            ...
            <div>
              <div className="flex items-center gap-x-2 pt-3">
                <h2 className="text-3xl font-bold">Access Settings</h2>
              </div>
              <ChapterAccessForm
                initialData={chapter}
                courseId={params.courseId}
          ...
          <div>
            <div className="flex items-center gap-x-2">
              <h2 className="text-3xl font-bold">Add a video</h2>
            </div>
            <VimeoVideoForm
              initialData={chapter}
              courseId={params.courseId}
