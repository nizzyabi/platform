  ...
  return (
    <div className="pt-40 mx-5 md:mx-20 pb-40 space-y-20 landing">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <p className="font-medium text-slate-100/70 pt-4">
          {course?.description2}
        </p>
      </div>
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <p className="font-medium text-slate-100/70 pt-4 whitespace-pre-wrap">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <p className="font-medium text-slate-100/80 pt-4 whitespace-pre-wrap">
          {course?.included}
        </p>
      </div>
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <p className="font-medium text-slate-100/80 mt-4 p-2 border border-slate-100/30 rounded-[5px] bg-zinc-900 whitespace-pre-wrap">
          {course?.difficulty}
        </p>
      </div>
                ...
                <div className="bg-zinc-900 shadow-lg shadow-black/50 rounded-[5px]  w-full p-6  flex flex-col hover:bg-opacity-80 transition duration-300 ease-in-out">
                  <div className="flex">
                    <h2 className="text-2xl font-bold text-white mb-4">
                      <span className="mr-2 font-extrabold text-2xl opacity-40">
