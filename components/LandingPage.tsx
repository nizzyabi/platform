  ...
  return (
    <div>
        ...
        <div className='text-center mt-8 md:mt-0 md:pr-10 w-full md:max-w-xl lg:max-w-2xl md:self-center'>
            ...
            <h1 className='slide-in-top text-xl sm:text-base md:text-xl lg:text-2xl font-bold text-'>learn to <span className='text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-600'>code</span> & have <span className='text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-teal-500'>fun</span> doing it.</h1>
        ...
        {/* Video */}
        <div className='w-full md:w-auto flex mr-12 justify-center items-center mt-10 slide-in-right'>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/KngzC93n19Q?si=RLTb9Crp21_htsEy" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className=' shadow-lg shadow-violet-500'></iframe>
        </div>
        ...
        <div ref={ref7} className={`transition-all duration-100 ${inView7 ? 'slide-in-bottom' : 'opacity-0'} flex items-center justify-center pt-[50px]`}>
        ...
        <div ref={ref3} className={`transition-all duration-500 ${inView3 ? 'slide-in-top' : 'opacity-0'} flex items-center justify-center mt-[250px]`}>
          <h1 className='rounded px-2 py-1.5 outline-dashed outline-purple-500 font-extrabold text-6xl text-purple-500 text-center'>The Answer 🧑‍💻</h1>
        </div>
        ...
        <div className='flex items-center justify-center pt-[30px] ml-[90px]'>
