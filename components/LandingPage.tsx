  ...
  return (
    <div>
        ...
        <div className='text-center mt-[100px]'>
            ...
            <Link href='/courses'>
                <Button className='font-extrabold border border-black rounded bg-white text-black text-xl hover:bg-purple-500 hover:text-white mt-5 hover:border-white slide-in-top'>
                Let's Start!
                </Button>
            </Link>
        ...
        // Intro Video
        <div className='flex justify-center items-center mt-10 slide-in-right'>
