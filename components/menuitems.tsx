...
const components: { title: any; href: string; description: string }[] = [
  {
    title: 'Lessons 📚',
    href: '/courses',
    description: 'Learn through a series of fun lessons'
  },
  {
    title: 'Applicable 📝',
    href: '/courses',
  ...
  },
  {
    ...
    description: 'Have fun and learn with others'
  },
  {
    title: 'Projects 🏗️',
    href: '/courses',
  ...
  },
  {
    title: 'Community 🌎',
    href: 'https://discord.com/invite/BenP3YkbJT',
    description: 'Build connections with others'
  },
  {
    title: 'Teaching 📖',
    href: '/courses',
    description: 'Become a teacher here'
  }
]
...
export function Features() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-lg md:text-lg font-medium hover:opacity-20">
            Features
          </NavigationMenuTrigger>
