...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center bg-[#3a3a3a] rounded-xl p-1 text-muted-foreground ",
      className
    )}
    {...props}
  />
