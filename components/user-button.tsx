...
const style = {
  ...
  return (
    <>
      {!session ? (
        <>
          <Link href='/auth/register' className='flex md:hidden items-center justify-center  rounded-lg cursor-pointer transition duration-300 hover:bg-primary/5 px-2 py-2'>
        ...
        >
          <div className="flex items-center px-5 lg:px-7 h-full bg-secondary rounded-md transition duration-300 text-primary hover:bg-transparent text-base lg:text-lg py-1.5">
            Sign Up
          </div>
        </Link>
        </>
