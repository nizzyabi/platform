...
const UserButton = () => {
    ...
    return (
        <div>
            {!session ? (
                 <Button
                        type="submit" onClick={onClick} className="p-[3px] relative font-semibold w-full bg-transparent">
                ...
                <Link href='/settings'>
                    {!session.image ? (
                        <Avatar 
                        alt='logo' src='/mesh.png' className="shadow-md shadow-black border-2 border-transparent hover:border-blue-500/50 duration-300"  sx={{ width: 40, height: 40}}>
                        </Avatar>
                    ): (
